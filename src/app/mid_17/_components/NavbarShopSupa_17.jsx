import Wrapper from '@/assets/wrappers/midterm/Shop_17'
// import { Link } from 'react-router-dom';
import Link from 'next/link'

const NavbarShopSupa_17 = () => {
  return (
    <Wrapper>
      <div className='header'>
        <Link href='/demo/shop_17/supabase' className='logo-container'>
...
export default NavbarShopSupa_17
